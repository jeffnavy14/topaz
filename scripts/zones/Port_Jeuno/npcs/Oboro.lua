...
function onTrade(player,npc,trade)
  ...
  elseif (trade:hasItemQty(18632, 1) and player:getVar("IridalUpgrade") < 1) then
    player:PrintToPlayer("Oboro : I can upgrade your Idiral Staff if you bring me 30 Beastmen Seals.", 0xD);
  elseif (trade:hasItemQty(18632, 1) and player:getVar("IridalUpgrade") == 1) then
    player:PrintToPlayer("Oboro : I can upgrade your Iridal Staff if you bring me 50 Beastmen Seals.", 0xD);
  elseif (trade:hasItemQty(18632, 1) and player:getVar("IridalUpgrade") == 2) then
    player:PrintToPlayer("Oboro : I can upgrade your Iridal Staff if you bring me 50 Kindred Seals.", 0xD);
  end
  ...
  elseif (trade:hasItemQty(18633, 1) and player:getVar("ChatoyantUpgrade") < 1) then
    player:PrintToPlayer("Oboro : I can upgrade your Chatoyant if you bring me 30 Beastmen Seals.", 0xD);
  elseif (trade:hasItemQty(18633, 1) and player:getVar("ChatoyantUpgrade") == 1) then
    player:PrintToPlayer("Oboro : I can upgrade your Chatoyant if you bring me 50 Beastmen Seals.", 0xD);
  elseif (trade:hasItemQty(18633, 1) and player:getVar("ChatoyantUpgrade") == 2) then
    player:PrintToPlayer("Oboro : I can upgrade your Chatoyant if you bring me 50 Kindred Seals.", 0xD);
  end
